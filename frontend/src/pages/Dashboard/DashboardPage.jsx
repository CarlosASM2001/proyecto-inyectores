...
function InvoiceStatusPill({ status }) {
  ...
  const isPaid = normalized === "paid" || normalized === "pagada";
  const isPending = normalized === "pending" || normalized === "pendiente";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex items-center justify-between border-l-4 border-workshop-red">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h4 className="text-xl font-black text-workshop-red italic leading-none">
                {formatMoneyCOP(derived.totalDebts)}
              </h4>
            </div>
          </div>
        </div>
                ...
                {derived.recentInvoices.map((inv) => (
                  <tr key={inv.id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-5 py-4 text-sm text-gray-900 font-black">
                      {formatMoneyCOP(inv.total_value)}
                    </td>
              ...
              return (
                <div key={d.id} className="p-5 flex items-start justify-between gap-4">
                  ...
                  <div className="font-black text-workshop-red italic">
                    {formatMoneyCOP(d.pending_balance)}
                  </div>
                </div>
              );
            })}
