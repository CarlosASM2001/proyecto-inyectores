                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-900 uppercase text-sm tracking-tighter font-black">
                        {service.name}
                      </span>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex justify-end gap-2 opacity-40 group-hover:opacity-100 transition-opacity">
                      <button
                        onClick={() => openModal(service)}
                        className="p-2 text-gray-400 hover:text-workshop-dark hover:bg-gray-100 rounded-lg transition-all"
                      >
                        <Edit size={18} />
                      </button>
                      <button
