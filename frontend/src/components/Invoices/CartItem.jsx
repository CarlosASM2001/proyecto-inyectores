    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden transition-all duration-200 hover:shadow-md">
      ...
      <div className="p-4">
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            ...
            <div className="flex items-end gap-2">
              <div className="font-black text-workshop-red text-xl">
                ...
                {formatCurrency(getConvertedAmount(item.price * item.quantity))}
              </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-2 rounded-lg text-workshop-red hover:bg-red-50 hover:text-red-600 transition-colors"
              title="Eliminar item"
            >
        ...
        <div className="text-sm text-gray-500 mt-2">
          ...
          {formatCurrency(getConvertedAmount(item.price))}
        </div>
      </div>

      {/* Detalles del servicio expandidos */}
      {isExpanded &&
        item.type === "Service" &&
        item.products &&
        item.products.length > 0 && (
          <div className="border-t border-gray-200 bg-gray-50 p-4">
            <div className="space-y-3">
              <div className="text-sm font-bold text-gray-700 uppercase tracking-wider">
                Componentes del servicio ({item.products.length} productos):
              </div>
